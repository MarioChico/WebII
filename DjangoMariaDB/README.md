...
docker exec -i 3a1 mysql -u dbuser -pUsr@2020.. --default-character-set=utf8  dbapi < C:\Users\Mario\Documents\DjangoMariadb\movies.sql

#MIGRATE Database
docker exec containername python manage.py inspectdb > models.py
docker exec ad7 python manage.py inspectdb > models.py

#### j
docker exec ad7 python manage.py makemigrations

#APPLY MODELDS
docker exec containername python manage.py migrate
docker exec ad7 python manage.py migrate
